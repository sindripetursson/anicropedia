        ...
        <div className="details__row">
            ...
            <div className="details__col__splitter">
                ...
                <div className="details__row">
                    ...
                    <div className="details__col">
                        <button id={"details_collection_button_art_" + props.singleResult.id} className={props.isInCollection ? "button__negative" : "button__positive"} onClick={() => props.onCollectionChange()}>{props.isInCollection?'Remove from My Island':'Add to My Island'}</button>
                    </div>
                </div>
            </div>
        </div>
