        ...
        <div className="details__row">
            <div className="details__col">
                ...
                <div className="checkmark__placeholder">
                    <div id={"details_checkmark1_art_" + props.singleResult.id} className={props.isInCollection ? "checkmark__image" : "hidden"} >
            ...
            <div className="details__col__splitter">
                <div className="details__row">
                    <div className="details__title">
                        ...
                        <img id={"details_checkmark2_art_" + props.singleResult.id} className={props.isInCollection ? "checkmark__details" : "hidden"} alt="checkmark" src="../../images/inCollection.svg"/> 
                    </div>
                </div>
                ...
                <div className="details__row">
                    ...
                    <div className="details__col">
                        <button id={"details_collection_button_art_" + props.singleResult.id} className={props.isInCollection ? "button__negative" : "button__positive"} onClick={() => props.onCollectionChange()}>{props.isInCollection?'Remove from my collection':'Add to my collection'}</button>
                    </div>
                </div>
            </div>
        </div>
